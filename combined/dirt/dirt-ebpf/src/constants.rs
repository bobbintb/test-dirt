...
pub static FSEVT: [FS_EVENT; 16] = [
    ...
    FS_EVENT { index: 4, value: FS_ATTRIB as i16, name: *b"ATTRIB\0\0\0\0\0\0\0\0\0", shortname: *b"ATT\0", shortname2: *b"AT\0\0" },
    FS_EVENT { index: 5, value: FS_MODIFY as i16, name: *b"MODIFY\0\0\0\0\0\0\0\0\0", shortname: *b"MOD\0", shortname2: *b"MO\0\0" },
    FS_EVENT { index: 6, value: FS_CLOSE_WRITE as i16, name: *b"CLOSE_WRITE\0\0\0\0\0", shortname: *b"CLW\0", shortname2: *b"CW\0\0" },
    FS_EVENT { index: 7, value: FS_CLOSE_NOWRITE as i16, name: *b"CLOSE_NOWRITE\0\0", shortname: *b"CLN\0", shortname2: *b"CN\0\0" },
    FS_EVENT { index: 8, value: FS_MOVED_FROM as i16, name: *b"MOVED_FROM\0\0\0\0\0", shortname: *b"MOF\0", shortname2: *b"MF\0\0" },
    FS_EVENT { index: 9, value: FS_MOVED_TO as i16, name: *b"MOVED_TO\0\0\0\0\0\0", shortname: *b"MOT\0", shortname2: *b"MT\0\0" },
    FS_EVENT { index: 10, value: FS_DELETE as i16, name: *b"DELETE\0\0\0\0\0\0\0\0\0", shortname: *b"DEL\0", shortname2: *b"DL\0\0" },
    FS_EVENT { index: 11, value: FS_DELETE_SELF as i16, name: *b"DELETE_SELF\0\0\0\0", shortname: *b"DLS\0", shortname2: *b"DS\0\0" },
    FS_EVENT { index: 12, value: FS_MOVE_SELF as i16, name: *b"MOVE_SELF\0\0\0\0\0\0", shortname: *b"MSL\0", shortname2: *b"MS\0\0" },
    FS_EVENT { index: 13, value: FS_UNMOUNT as i16, name: *b"UNMOUNT\0\0\0\0\0\0\0", shortname: *b"UMT\0", shortname2: *b"UM\0\0" },
    FS_EVENT { index: 14, value: FS_Q_OVERFLOW as i16, name: *b"Q_OVERFLOW\0\0\0\0\0", shortname: *b"QOF\0", shortname2: *b"QO\0\0" },
